...
\033[1;94m        𝑴𝒓𝒙 𝑱𝒊𝒃𝒐𝒏      
\033[1;95m{ 𝑴𝒓𝒙 𝑱𝒊𝒃𝒐𝒏 𝑯𝒂𝒄𝒌𝒆𝒓              ⠀⠀⠀ (\**/)**
⠀⠀⠀ **(•ㅅ•)      𝐃𝐨𝐧’𝐭 𝐓𝐚𝐥𝐤 𝐭𝐨
＿ノヽ ノ＼＿      𝐌𝐞 𝐎𝐫 𝐌𝐲 𝐒𝐨𝐧
/  / ⌒Ｙ⌒ Ｙ  ヽ     𝐄𝐯𝐞𝐫 𝐀𝐠𝐚𝐢𝐧.
( 　(三ヽ人　 /　  |  { 𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧 }
|　ﾉ⌒＼ ￣￣ヽ   ノ
ヽ＿＿＿＞､＿_／**
...
\033[1;91m           { 𝐌𝐃 𝐉𝐈𝐁𝐎𝐍 𝐈𝐒𝐋𝐀𝐌 } 
\033[1;92m                𝑴𝒓𝒙 𝑱𝒊𝒃𝒐𝒏 𝑯𝒂𝒄𝒌𝒆𝒓
\033[1;95m              __________  ____  _   __
\033[1;93m             / /  _/ __ )/ __ \/ | / /
\033[1;94m        __  / // // __  / / / /  |/ / 
\033[1;95m       / /_/ // // /_/ / /_/ / /|  /
\033[1;92m       \____/___/_____/\____/_/ |_/  
\033[1;91m                𝑴𝒓𝒙 𝑱𝒊𝒃𝒐𝒏 𝑯𝒂𝒄𝒌𝒆𝒓                                         
...
def fuck():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print('[+] 𝐏𝐑𝐎𝐂𝐄𝐒𝐒 𝐇𝐀𝐒 𝐁𝐄𝐍𝐍 𝐒𝐓𝐀𝐑𝐓𝐄𝐃')
        print('[+] 𝐔𝐒𝐄 𝐅𝐋𝐈𝐆𝐇𝐓 𝐌𝐎𝐃𝐄 𝐅𝐎𝐑 𝐒𝐏𝐄𝐄𝐃 𝐔𝐏 » 𝐕.1.12')
        print('==================================================')
        for love in user:
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[𝐌𝐫𝐱 𝐉𝐢𝐛𝐨𝐧]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
